...
namespace DavRelayUp.Ndr {
    ...
    internal class _Marshal_Helper : DavRelayUp.Ndr.Marshal.NdrMarshalBuffer {
    ...
    internal class _Unmarshal_Helper : DavRelayUp.Ndr.Marshal.NdrUnmarshalBuffer {
    ...
    public struct _PAC_DEVICE_INFO : DavRelayUp.Ndr.Marshal.INdrStructure {
        void DavRelayUp.Ndr.Marshal.INdrStructure.Marshal(DavRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
        ...
        void DavRelayUp.Ndr.Marshal.INdrStructure.Unmarshal(DavRelayUp.Ndr.Marshal.NdrUnmarshalBuffer u) {
        ...
        int DavRelayUp.Ndr.Marshal.INdrStructure.GetAlignment() {
            return 4;
        }
        public int UserId;
        public int PrimaryGroupId;
        public DavRelayUp.Ndr.Marshal.NdrEmbeddedPointer<_RPC_SID> AccountDomainId;
        public int AccountGroupCount;
        public DavRelayUp.Ndr.Marshal.NdrEmbeddedPointer<_GROUP_MEMBERSHIP[]> AccountGroupIds;
        public int SidCount;
        public DavRelayUp.Ndr.Marshal.NdrEmbeddedPointer<_KERB_SID_AND_ATTRIBUTES[]> ExtraSids;
        public int DomainGroupCount;
        public DavRelayUp.Ndr.Marshal.NdrEmbeddedPointer<DOMAIN_GROUP_MEMBERSHIP[]> DomainGroup;
    ...
    public struct _RPC_SID : DavRelayUp.Ndr.Marshal.INdrConformantStructure {
        void DavRelayUp.Ndr.Marshal.INdrStructure.Marshal(DavRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
            ...
            m.Write_22(DavRelayUp.Win32.Rpc.RpcUtils.CheckNull(SubAuthority, "SubAuthority"), SubAuthorityCount);
        }
        void DavRelayUp.Ndr.Marshal.INdrStructure.Unmarshal(DavRelayUp.Ndr.Marshal.NdrUnmarshalBuffer u) {
            Unmarshal(((_Unmarshal_Helper)(u)));
        }
        ...
        int DavRelayUp.Ndr.Marshal.INdrConformantStructure.GetConformantDimensions() {
            return 1;
        }
        int DavRelayUp.Ndr.Marshal.INdrStructure.GetAlignment() {
            return 4;
    ...
    public struct _RPC_SID_IDENTIFIER_AUTHORITY : DavRelayUp.Ndr.Marshal.INdrStructure {
        void DavRelayUp.Ndr.Marshal.INdrStructure.Marshal(DavRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
            m.Write_23(DavRelayUp.Win32.Rpc.RpcUtils.CheckNull(Value, "Value"));
        }
        void DavRelayUp.Ndr.Marshal.INdrStructure.Unmarshal(DavRelayUp.Ndr.Marshal.NdrUnmarshalBuffer u) {
            Unmarshal(((_Unmarshal_Helper)(u)));
        }
    ...
    public struct _FILETIME : DavRelayUp.Ndr.Marshal.INdrStructure {
        void DavRelayUp.Ndr.Marshal.INdrStructure.Marshal(DavRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
    ...
    public struct _GROUP_MEMBERSHIP : DavRelayUp.Ndr.Marshal.INdrStructure {
        void DavRelayUp.Ndr.Marshal.INdrStructure.Marshal(DavRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
    ...
    public struct _KERB_SID_AND_ATTRIBUTES : DavRelayUp.Ndr.Marshal.INdrStructure {
        void DavRelayUp.Ndr.Marshal.INdrStructure.Marshal(DavRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
        ...
        public DavRelayUp.Ndr.Marshal.NdrEmbeddedPointer<_RPC_SID> Sid;
        public int Attributes;
    ...
    public struct DOMAIN_GROUP_MEMBERSHIP : DavRelayUp.Ndr.Marshal.INdrStructure {
        void DavRelayUp.Ndr.Marshal.INdrStructure.Marshal(DavRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
        ...
        public DavRelayUp.Ndr.Marshal.NdrEmbeddedPointer<_RPC_SID> DomainId;
        public int GroupCount;
        public DavRelayUp.Ndr.Marshal.NdrEmbeddedPointer<_GROUP_MEMBERSHIP[]> GroupIds;
    ...
    public struct _PAC_DEVICE_CLAIMS_INFO : DavRelayUp.Ndr.Marshal.INdrStructure {
        void DavRelayUp.Ndr.Marshal.INdrStructure.Marshal(DavRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
        ...
        public DavRelayUp.Ndr.Marshal.NdrEmbeddedPointer<_CLAIMS_SET_METADATA> Claims;
    ...
    public struct _CLAIMS_SET_METADATA : DavRelayUp.Ndr.Marshal.INdrStructure {
        void DavRelayUp.Ndr.Marshal.INdrStructure.Marshal(DavRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
        ...
        public DavRelayUp.Ndr.Marshal.NdrEmbeddedPointer<byte[]> ClaimsSet;
        public DavRelayUp.Ndr.Marshal.NdrEnum16 usCompressionFormat;
        public int ulUncompressedClaimsSetSize;
        public short usReservedType;
        public int ulReservedFieldSize;
        public DavRelayUp.Ndr.Marshal.NdrEmbeddedPointer<byte[]> ReservedField;
        public static _CLAIMS_SET_METADATA CreateDefault() {
            return new _CLAIMS_SET_METADATA();
        }
        public _CLAIMS_SET_METADATA(int ulClaimsSetSize, byte[] ClaimsSet, DavRelayUp.Ndr.Marshal.NdrEnum16 usCompressionFormat, int ulUncompressedClaimsSetSize, short usReservedType, int ulReservedFieldSize, byte[] ReservedField) {
    ...
    public struct _UPN_DNS_INFO : DavRelayUp.Ndr.Marshal.INdrStructure {
        void DavRelayUp.Ndr.Marshal.INdrStructure.Marshal(DavRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
    ...
    public struct _KERB_VALIDATION_INFO : DavRelayUp.Ndr.Marshal.INdrStructure {
        void DavRelayUp.Ndr.Marshal.INdrStructure.Marshal(DavRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
            ...
            m.Write_28(DavRelayUp.Win32.Rpc.RpcUtils.CheckNull(Reserved1, "Reserved1"));
            m.WriteInt32(UserAccountControl);
            m.Write_29(DavRelayUp.Win32.Rpc.RpcUtils.CheckNull(Reserved3, "Reserved3"));
            m.WriteInt32(SidCount);
        ...
        public DavRelayUp.Ndr.Marshal.NdrEmbeddedPointer<_RPC_SID> LogonDomainId;
        public int[] Reserved1;
        public int UserAccountControl;
        public int[] Reserved3;
        public int SidCount;
        public DavRelayUp.Ndr.Marshal.NdrEmbeddedPointer<_KERB_SID_AND_ATTRIBUTES[]> ExtraSids;
        public DavRelayUp.Ndr.Marshal.NdrEmbeddedPointer<_RPC_SID> ResourceGroupDomainSid;
        public int ResourceGroupCount;
        public DavRelayUp.Ndr.Marshal.NdrEmbeddedPointer<_GROUP_MEMBERSHIP[]> ResourceGroupIds;
    ...
    public struct _RPC_UNICODE_STRING : DavRelayUp.Ndr.Marshal.INdrStructure {
        void DavRelayUp.Ndr.Marshal.INdrStructure.Marshal(DavRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
        ...
        public DavRelayUp.Ndr.Marshal.NdrEmbeddedPointer<char[]> Buffer;
    ...
    public struct _USER_SESSION_KEY : DavRelayUp.Ndr.Marshal.INdrStructure {
        void DavRelayUp.Ndr.Marshal.INdrStructure.Marshal(DavRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
            m.Write_33(DavRelayUp.Win32.Rpc.RpcUtils.CheckNull(data, "data"));
        }
        void DavRelayUp.Ndr.Marshal.INdrStructure.Unmarshal(DavRelayUp.Ndr.Marshal.NdrUnmarshalBuffer u) {
            Unmarshal(((_Unmarshal_Helper)(u)));
        }
    ...
    public struct _CYPHER_BLOCK : DavRelayUp.Ndr.Marshal.INdrStructure {
        void DavRelayUp.Ndr.Marshal.INdrStructure.Marshal(DavRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
            m.Write_34(DavRelayUp.Win32.Rpc.RpcUtils.CheckNull(data, "data"));
        }
        void DavRelayUp.Ndr.Marshal.INdrStructure.Unmarshal(DavRelayUp.Ndr.Marshal.NdrUnmarshalBuffer u) {
            Unmarshal(((_Unmarshal_Helper)(u)));
        }
    ...
    public struct _PAC_INFO_BUFFER : DavRelayUp.Ndr.Marshal.INdrStructure {
        void DavRelayUp.Ndr.Marshal.INdrStructure.Marshal(DavRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
    ...
    public struct _NTLM_SUPPLEMENTAL_CREDENTIAL : DavRelayUp.Ndr.Marshal.INdrStructure {
        void DavRelayUp.Ndr.Marshal.INdrStructure.Marshal(DavRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
            ...
            m.WriteInt32(Flags);
            m.Write_35(DavRelayUp.Win32.Rpc.RpcUtils.CheckNull(LmPassword, "LmPassword"));
            m.Write_35(DavRelayUp.Win32.Rpc.RpcUtils.CheckNull(NtPassword, "NtPassword"));
        }
        void DavRelayUp.Ndr.Marshal.INdrStructure.Unmarshal(DavRelayUp.Ndr.Marshal.NdrUnmarshalBuffer u) {
            Unmarshal(((_Unmarshal_Helper)(u)));
        }
    ...
    public struct _PAC_CLIENT_INFO : DavRelayUp.Ndr.Marshal.INdrStructure {
        void DavRelayUp.Ndr.Marshal.INdrStructure.Marshal(DavRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
            ...
            m.Write_36(DavRelayUp.Win32.Rpc.RpcUtils.CheckNull(Name, "Name"));
        }
        void DavRelayUp.Ndr.Marshal.INdrStructure.Unmarshal(DavRelayUp.Ndr.Marshal.NdrUnmarshalBuffer u) {
            Unmarshal(((_Unmarshal_Helper)(u)));
        }
    ...
    public struct _S4U_DELEGATION_INFO : DavRelayUp.Ndr.Marshal.INdrStructure {
        void DavRelayUp.Ndr.Marshal.INdrStructure.Marshal(DavRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
        ...
        public DavRelayUp.Ndr.Marshal.NdrEmbeddedPointer<_RPC_UNICODE_STRING[]> S4UTransitedServices;
    ...
    public struct _PAC_CREDENTIAL_DATA : DavRelayUp.Ndr.Marshal.INdrConformantStructure {
        void DavRelayUp.Ndr.Marshal.INdrStructure.Marshal(DavRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
            m.WriteInt32(CredentialCount);
            m.Write_38(DavRelayUp.Win32.Rpc.RpcUtils.CheckNull(Credentials, "Credentials"), CredentialCount);
        }
        void DavRelayUp.Ndr.Marshal.INdrStructure.Unmarshal(DavRelayUp.Ndr.Marshal.NdrUnmarshalBuffer u) {
            Unmarshal(((_Unmarshal_Helper)(u)));
        }
    ...
    public struct _SECPKG_SUPPLEMENTAL_CRED : DavRelayUp.Ndr.Marshal.INdrStructure {
        void DavRelayUp.Ndr.Marshal.INdrStructure.Marshal(DavRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
        ...
        public DavRelayUp.Ndr.Marshal.NdrEmbeddedPointer<sbyte[]> Credentials;
